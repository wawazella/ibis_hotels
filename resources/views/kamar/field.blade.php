<div class="row">
    <div class="col-md-4 mb-3">
        ...
        <input type="text" class="form-control" name="nama_kamar" id="nama_kamar" required value="{{ isset($data) ? @$data->nama_kamar : ''}}">
    </div>
    <div class="col-md-4 mb-3">
        <label for="gambar_kamar">Gambar Resep</label>
    ...
    <div class="col-md-4 mb-3">
        ...
        <input type="text" class="form-control" name="harga" id="harga" value="{{ isset($data) ? @$data->harga : ''}}">
    </div>

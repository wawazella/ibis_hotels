...
<body>
    <div class="container mt-2">
        <div class="row">
            <div class="col-lg-12 margin-tb">
                <div class="pull-left mb-2">
                    <h2>Add category kamar</h2>
                </div>
                {{-- open untuk menyambungkan pada route pada create tabel --}}
                <div class="pull-right">
                    <a class="btn btn-primary" href="{{ route('categorykamar.index') }}"> Back</a>
                </div>
        ...
        <form action="{{ route('categorykamar.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
